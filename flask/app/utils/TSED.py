# Computes similarity of two Python codes based on their AST
# heavily inspired from https://github.com/Etamin/TSED
...
def _parse(program_str: str, encoding="utf-8") -> Tree:
...
def _get_tree(tree_str: str) -> Node:
    ...
    """
    tree_sitter_representation = _parse(tree_str)
